...
function toolbarChanged() {
	...
	if ( "hidepassed" === field.name && "replaceState" in window.history ) {
		...
		//window.history.replaceState( null, "", updatedUrl ); // XSS
	} else {
		//window.location = updatedUrl; // XSS
	}
}
...
function setUrl( params ) {
	...
	//return location.protocol + "//" + location.host + // XSS
		//location.pathname + querystring.slice( 0, -1 ); // XSS
}
...
QUnit.log(function( details ) {
	...
	//assertLi.innerHTML = message; // XSS

...
(function ($) {
    ...
    $.fn.metalClone = function (options, callback) {
        ...
        return base.each(function () {
            ...
            $(document).on('click', currentBtnClone, function () {
                ...
                (function (newTypeSelector) {
                    opt.cancelClone = function (flag) {
                        if (flag)
                            window[newTypeSelector + 'cancelClone'] = flag;
                    };
                    opt.removeCloned = function (flag) {
                        if (flag)
                            window[newTypeSelector + 'removeCloned'] = flag;
                    };
                })(newTypeSelector);
                ...
                if ($.isFunction(onComplete))
                    onComplete.call(base, clonedElement, cloned, toClone);
                ...
                if (window[newTypeSelector + 'removeCloned'] && typeof window[newTypeSelector + 'removeCloned'] !== undefined) {
                    ...
                    if ($.isFunction(onClonedRemoved))
                        onClonedRemoved.call(base, toClone);
                ...
                if (position === "after") {
                    ...
                    if (($.inArray(nodeType, allNodeTableWithout) !== -1) && ($.inArray(destinationNodeType, allNodeTableWithout) !== -1)) {
                        ...
                        for (var i = 0; i < numberToClone; i++) {
                            ...
                            if (currentCopyValue) { /* never copy */
                            } else {
                                clearForm(toClone);
                            }
                    ...
                    // if selection is a table && destination not a table
                        ...
                        for (var i = 0; i < numberToClone; i++) {
                            ...
                            if (check)
                                return;
                            toClone = cloneObj.clone();
                            destination.append(toClone.append('<input type="button" value="' + currentBtnRemoveText + '" class="metalBtnRemove btn btn-danger">'));
                            if (currentCopyValue) { /* never copy */
                            } else {
                                clearForm(toClone);
                            }
                    ...
                    // table element but destination not table element
                        ...
                        for (var i = 0; i < numberToClone; i++) {
                            ...
                            if (check)
                                return;
                            toClone = cloneObj.clone();
                            destination.prepend(toClone.append('<input type="button" value="' + currentBtnRemoveText + '" class="metalBtnRemove btn btn-danger">'));
                            if (currentCopyValue) { /* never copy */
                            } else {
                                clearForm(toClone);
                            }
                ...
                if (position === "after") {
                    ...
                    if (($.inArray(nodeType, allNodeTableWithout) == -1)) {
                        ...
                        for (var i = 0; i < numberToClone; i++) {
                            ...
                            toClone = cloneObj.clone();
                            toClone.insertAfter(destination)
                                    .append('<input type="button" value="' + currentBtnRemoveText + '" class="metalBtnRemove btn btn-danger">');
            ...
            $(document).on('click', '.metalBtnRemove', function () {
                ...
                // param1 - removed element
                if ($.isFunction(onClonedRemoved))
                    onClonedRemoved.call(base, parentToRemove);
    ...
    $.fn.metalClone.defaults = {
        ...
        btnRemoveText: 'X', // Text appear on remove button

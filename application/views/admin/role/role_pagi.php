                            ...
                            foreach ($list_res as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . 'admin/Role/manage_role/' . $row->role_id; ?>" class="btn btn-info yellow" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil mr-0" aria-hidden="true"></i></a>
                                        <a href="javascript:show_popup('<?php echo $row->role_id ?>','<?php echo $cur_page ?>','Active');" data-toggle="tooltip" title="Delete" class="btn  btn-info red" data-original-title="" style="background-color: red;"><i class="fa fa-close mr-0" aria-hidden="true"></i></a>
                                        <?php
                                        /* } else {
                                          echo "System Generated Roles";
                                          } */
                                        ?>
                                    </td>
                                </tr>

    ...
    <body>
        <header class="header-upper style-two affix">
            <div id="app" class="container">
                <nav class="navbar navbar-expand-lg navbar-light bg-faded" style="width:100%;"> <a class="navbar-brand" href="<?php echo base_url(); ?>"><img src="<?php echo base_url() . 'assets/images/logo.png' ?>"/></a>
                        ...
                        <div class="col-lg-6">
                            <div class="consultation-form-two with-shadow ">
                                <div class="default-form-area">
                                    ...
                                    <form id="reset_form" name="" class="contact-form style-two reset_form" method="post">
